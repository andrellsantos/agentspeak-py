...
# Python implementation of algorithms from Russell and Norvigs "Artificial Intelligence - A Modern Approach" 
# Fonte: http://aima.cs.berkeley.edu/python/utils.html
# Licença: MIT
